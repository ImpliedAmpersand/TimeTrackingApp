$('#tablebody').on('click', '.clockout-submit', function() {
  ...
  $('#tablebody').on('click', '.edit-clockin-submit', function() {
    const buttonId = $(this).attr('id');
    console.log(buttonId);
    const clockoutInput = $('.edit-hours-input' + buttonId);
    const newTime = clockoutInput.val().trim();
  ...
  $('#tablebody').on('click', '.edit-clockout-submit', function() {
    const buttonId = $(this).attr('id');
    console.log(buttonId);
    const clockoutInput = $('#editHoursInput' + buttonId);
    const newTime = clockoutInput.val().trim();
  ...
  $('#tablebody').on('click', '.add-lunch', function() {
    const buttonId = $(this).attr('id');
    console.log(buttonId);
  
      $.ajax({
        url: '/change-lunch', // Replace with your server endpoint for updating clock out time
        type: 'POST',
        data: JSON.stringify({
          id: buttonId,
          lunch: 1,
  ...
  $('#tablebody').on('click', '.sub-lunch', function() {
    const buttonId = $(this).attr('id');
    console.log(buttonId);
